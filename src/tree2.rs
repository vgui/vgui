...
impl TreeNode
{	
	pub fn new(parent : Option<RcRefCell<Self>>,childindex : usize , data : impl Widget) -> RcRefCell<Self>
	{
	...
	pub fn data(&self) -> impl Widget
	{
		&self.data
	}	

	pub fn data_mut(&mut self) -> impl Widget
	{
		&mut self.data
	}		
}
